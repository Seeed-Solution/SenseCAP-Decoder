...
////decoder for SenseCAP S2120 for AWS IoT Lambda and js 20.x
///by Gabriele Foddis
///2024/07/05
...
exports.handler = (event, context) => {
    ...
    console.log('PayloadData is =', event.PayloadData);
    console.log('DevEui is =', event.WirelessMetadata.LoRaWAN.DevEui);
    console.log('Timestamp data is =', event.WirelessMetadata.LoRaWAN.Timestamp);

var region = "eu-central-1"; ///change with your region
var endpoint = "https://afdasfda-ats.iot.eu-central-1.amazonaws.com"; ///change with your Endpoint
var  dataFromWeatherStation;
var dataDecoded;
var idDevice = devEui;
var payloadDecoded;
var TOPIC_S2120 = 'decoded/Weather_Station_S2120';
var data = event.PayloadData;
var devEui = event.WirelessMetadata.LoRaWAN.DevEui;
const buffer = Buffer.from(data, 'base64');
var time =  event.WirelessMetadata.LoRaWAN.Timestamp;
var buffPayload = Buffer.from(event.PayloadData, 'base64');
...
payloadDecoded = decodeUplink(buffPayload)
dataFromWeatherStation = payloadDecoded
dataDecoded = dataFromWeatherStation;
idDevice = devEui.toString();
...
dataDecoded.TimeAndEui = timeAndEui
;

async function publishMessageToIoTTopic(event2) {
